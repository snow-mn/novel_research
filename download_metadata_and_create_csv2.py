...
def get_all_novel_info():
    ...
    # 出力パラメータの設定
    # 総合ポイントの下限と文字数の上限を設定
    payload = {'out': 'json', 'gzip': 5, 'of': 'n', 'lim': 1, "min_globalpoint": 1000, "length": -500000}
    # レスポンスをcontent形式で取得
    ...
    for i in tqdm(range(all_queue_cnt)):
        payload = {'out': 'json', 'gzip': 5, 'opt': 'weekly', 'lim': 500, 'lastup': "1073779200-" + str(lastup), "min_globalpoint": 1000, "length": -500000}
